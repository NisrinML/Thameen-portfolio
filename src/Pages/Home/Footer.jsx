  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/share/1GAvo2VBKo/"
            ...
            <li>
              <a
                href="https://www.instagram.com/tameen.koronfli?igsh=NTc0bHdseXE5dzBo"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/thameen-qoronfli-926b68229/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Copyright 2025 © Thameen Kronfle</p>
        {/* <div className="footer--social--icon">
          <ul>
            <li>
              <Link
